...
class JogoPergunta9Page extends StatefulWidget {
  const JogoPergunta9Page({super.key});

  @override
  State<JogoPergunta9Page> createState() => _JogoPergunta9Page();
}

class _JogoPergunta9Page extends State<JogoPergunta9Page> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Em casos graves, o câncer de pulmão pode se espalhar para:',
