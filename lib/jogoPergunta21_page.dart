...
class JogoPergunta21Page extends StatefulWidget {
  const JogoPergunta21Page({super.key});

  @override
  State<JogoPergunta21Page> createState() => _JogoPergunta21Page();
}

class _JogoPergunta21Page extends State<JogoPergunta21Page> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Qual destas alternativas ajuda na reabilitação de pacientes com câncer de pulmão?',
            ...
            Container(
              ...
              child: Column(
                children: [
                  opcao('A', 'Comer doces em excesso'),
                  opcao('B', 'Praticar fisioterapia respiratória'),
                  opcao('C', 'Se isolar em casa'),
                  opcao('D', 'Tomar remédios sem prescrição'),
                ],
              ),
            ),
