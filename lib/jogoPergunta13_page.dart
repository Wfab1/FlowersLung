...
class JogoPergunta13Page extends StatefulWidget {
  const JogoPergunta13Page({super.key});

  @override
  State<JogoPergunta13Page> createState() => _JogoPergunta13Page();
}

class _JogoPergunta13Page extends State<JogoPergunta13Page> {
  @override
