...
class JogoPergunta26Page extends StatefulWidget {
  const JogoPergunta26Page({super.key});

  @override
  State<JogoPergunta26Page> createState() => _JogoPergunta26Page();
}

class _JogoPergunta26Page extends State<JogoPergunta26Page> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Que substância presente na fumaça do cigarro prejudica a oxigenação do corpo?',
