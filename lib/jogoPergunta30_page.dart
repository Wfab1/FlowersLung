...
class JogoPergunta30Page extends StatefulWidget {
  const JogoPergunta30Page({super.key});

  @override
  State<JogoPergunta30Page> createState() => _JogoPergunta30Page();
}

class _JogoPergunta30Page extends State<JogoPergunta30Page> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'O que pode ser feito em campanhas de prevenção ao câncer de pulmão?',
            ...
            Container(
              ...
              child: Column(
                children: [
                  opcao('A', 'Incentivar o uso do cigarro eletrônico'),
                  opcao('B', 'Aumentar os riscos do fumo passivo'),
                  opcao('C', 'Divulgar tratamentos alternativos sem comprovação científica'),
                  opcao('D', 'Distribuir panfletos informativos e promover ações antitabagismo'),
                ],
              ),
            ),
