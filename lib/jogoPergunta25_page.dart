...
class JogoPergunta25Page extends StatefulWidget {
  const JogoPergunta25Page({super.key});

  @override
  State<JogoPergunta25Page> createState() => _JogoPergunta25Page();
}

class _JogoPergunta25Page extends State<JogoPergunta25Page> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Qual das opções abaixo é uma consequência frequente do tabagismo além do câncer de pulmão?',
            ...
            Container(
              ...
              child: Column(
                children: [
                  opcao('A', 'Catarata'),
                  opcao('B', 'Artrite'),
                  opcao('C', 'Doença pulmonar obstrutiva crônica (DPOC)'),
                  opcao('D', 'Hipotireoidismo'),
                ],
              ),
            ),
