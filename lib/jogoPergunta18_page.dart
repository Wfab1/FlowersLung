...
class JogoPergunta18Page extends StatefulWidget {
  const JogoPergunta18Page({super.key});

  @override
  State<JogoPergunta18Page> createState() => _JogoPergunta18Page();
}

class _JogoPergunta18Page extends State<JogoPergunta18Page> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Qual é a consequência do câncer de pulmão não tratado?',
            ...
            Container(
              ...
              child: Column(
                children: [
                  opcao('A', 'Dor nas unhas'),
                  opcao('B', 'Resfriados constantes'),
                  opcao('C', 'Metástase para outros órgãos'),
                  opcao('D', 'Crescimento dos cabelos'),
                ],
              ),
            ),
