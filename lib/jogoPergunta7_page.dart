...
class JogoPergunta7Page extends StatefulWidget {
  const JogoPergunta7Page({super.key});

  @override
  State<JogoPergunta7Page> createState() => _JogoPergunta7Page();
}

class _JogoPergunta7Page extends State<JogoPergunta7Page> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Um sintoma avançado do câncer de pulmão pode incluir:',
            ...
            Container(
              ...
              child: Column(
                children: [
                  opcao('A', 'Febre alta e súbita'),
                  opcao('B', 'Dor no peito ao respirar profundamente'),
                  opcao('C', 'Dor nos pés'),
                  opcao('D', 'Fome constante'),
                ],
              ),
            ),
