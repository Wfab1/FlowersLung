...
class JogoPergunta29Page extends StatefulWidget {
  const JogoPergunta29Page({super.key});

  @override
  State<JogoPergunta29Page> createState() => _JogoPergunta29Page();
}

class _JogoPergunta29Page extends State<JogoPergunta29Page> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Qual a principal forma de diagnóstico por imagem para detectar câncer de pulmão?',
            ...
            Container(
              ...
              child: Column(
                children: [
                  opcao('A', 'Ultrassonografia abdominal'),
                  opcao('B', 'Endoscopia digestiva'),
                  opcao('C', 'Tomografia computadorizada do tórax'),
                  opcao('D', 'Ressonância do crânio'),
                ],
              ),
            ),
