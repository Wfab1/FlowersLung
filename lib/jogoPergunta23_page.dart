...
class JogoPergunta23Page extends StatefulWidget {
  const JogoPergunta23Page({super.key});

  @override
  State<JogoPergunta23Page> createState() => _JogoPergunta23Page();
}

class _JogoPergunta23Page extends State<JogoPergunta23Page> {
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Scaffold(
        ...
        body: buildListView(35, 65, 20, 30, 40),
      ),
    );
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Uma forma de apoio comunitário a pessoas com câncer de pulmão é:',
            ...
            Container(
              ...
              child: Column(
                children: [
                  opcao('A', 'Evitar falar com elas sobre saúde'),
                  opcao('B', 'Compartilhar fake news sobre curas milagrosas'),
                  opcao('C', 'Forçar a pessoa a praticar esportes intensos'),
                  opcao('D', 'Organizar grupos de escuta e apoio emocional'),
                ],
              ),
            ),
