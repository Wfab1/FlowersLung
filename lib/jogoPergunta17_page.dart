...
class JogoPergunta17Page extends StatefulWidget {
  const JogoPergunta17Page({super.key});

  @override
  State<JogoPergunta17Page> createState() => _JogoPergunta17Page();
}

class _JogoPergunta17Page extends State<JogoPergunta17Page> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Qual destas substâncias presentes no cigarro é cancerígena?',
