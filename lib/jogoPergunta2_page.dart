...
class JogoPergunta2Page extends StatefulWidget {
  const JogoPergunta2Page({super.key});

  @override
  State<JogoPergunta2Page> createState() => _JogoPergunta2Page();
}

class _JogoPergunta2Page extends State<JogoPergunta2Page> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Qual é um fator de risco ocupacional para o desenvolvimento do câncer de pulmão?',
            ...
            Container(
              ...
              child: Column(
                children: [
                  opcao('A', 'Uso prolongado de computador'),
                  opcao('B', 'Exposição ao amianto (asbesto)'),
                  opcao('C', 'Trabalhar em locais com ar-condicionado'),
                  opcao('D', 'Permanecer muito tempo em pé'),
                ],
              ),
            ),
