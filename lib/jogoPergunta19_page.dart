...
class JogoPergunta19Page extends StatefulWidget {
  const JogoPergunta19Page({super.key});

  @override
  State<JogoPergunta19Page> createState() => _JogoPergunta19Page();
}

class _JogoPergunta19Page extends State<JogoPergunta19Page> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Qual alternativa a seguir representa um grupo de risco para o câncer de pulmão?',
            ...
            Container(
              ...
              child: Column(
                children: [
                  opcao('A', 'Crianças que praticam esportes'),
                  opcao('B', 'Pessoas que bebem refrigerante'),
                  opcao('C', 'Vegetarianos'),
                  opcao('D', 'Pessoas expostas à fumaça do cigarro'),
                ],
              ),
            ),
