...
class JogoPergunta8Page extends StatefulWidget {
  const JogoPergunta8Page({super.key});

  @override
  State<JogoPergunta8Page> createState() => _JogoPergunta8Page();
}

class _JogoPergunta8Page extends State<JogoPergunta8Page> {
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Scaffold(
        ...
        body: buildListView(25, 55, 10, 20, 30),
      ),
    );
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'O que pode ajudar na prevenção do câncer de pulmão?',
            ...
            Container(
              ...
              child: Column(
                children: [
                  opcao('A', 'Parar de fumar'),
                  opcao('B', 'Tomar antibióticos regularmente'),
                  opcao('C', 'Dormir mais de 10 horas por dia'),
                  opcao('D', 'Evitar alimentos com glúten'),
                ],
              ),
            ),
