...
class JogoPergunta10Page extends StatefulWidget {
  const JogoPergunta10Page({super.key});

  @override
  State<JogoPergunta10Page> createState() => _JogoPergunta10Page();
}

class _JogoPergunta10Page extends State<JogoPergunta10Page> {
  @override
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  opcao('A', 'Crianças'),
                  opcao('B', 'Mulheres jovens'),
                  opcao('C', 'Adultos fumantes com mais de 50 anos'),
                  opcao('D', 'Atletas profissionais'),
                ],
              ),
            ),
