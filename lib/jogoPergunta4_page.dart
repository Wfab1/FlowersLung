...
class JogoPergunta4Page extends StatefulWidget {
  const JogoPergunta4Page({super.key});

  @override
  State<JogoPergunta4Page> createState() => _JogoPergunta4Page();
}

class _JogoPergunta4Page extends State<JogoPergunta4Page> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Além do cigarro comum, qual outro produto também está ligado ao aumento do risco de câncer de pulmão?',
            ...
            Container(
              ...
              child: Column(
                children: [
                  opcao('A', 'Bebidas energéticas'),
                  opcao('B', 'Sal em excesso'),
                  opcao('C', 'Cigarro eletrônico'),
                  opcao('D', 'Café'),
                ],
              ),
            ),
