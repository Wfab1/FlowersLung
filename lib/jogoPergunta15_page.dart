...
class JogoPergunta15Page extends StatefulWidget {
  const JogoPergunta15Page({super.key});

  @override
  State<JogoPergunta15Page> createState() => _JogoPergunta15Page();
}

class _JogoPergunta15Page extends State<JogoPergunta15Page> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Qual atitude pode ajudar uma pessoa com câncer de pulmão?',
