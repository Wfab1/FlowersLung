...
class JogoPergunta28Page extends StatefulWidget {
  const JogoPergunta28Page({super.key});

  @override
  State<JogoPergunta28Page> createState() => _JogoPergunta28Page();
}

class _JogoPergunta28Page extends State<JogoPergunta28Page> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Um sinal de alerta para o câncer de pulmão que exige atenção médica é:',
            ...
            Container(
              ...
              child: Column(
                children: [
                  opcao('A', 'Suor nas mãos ao dormir'),
                  opcao('B', 'Tosse com sangue'),
                  opcao('C', 'Sonolência após o almoço'),
                  opcao('D', 'Dores musculares após esforço físico'),
                ],
              ),
            ),
