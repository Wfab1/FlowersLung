...
class JogoPergunta24Page extends StatefulWidget {
  const JogoPergunta24Page({super.key});

  @override
  State<JogoPergunta24Page> createState() => _JogoPergunta24Page();
}

class _JogoPergunta24Page extends State<JogoPergunta24Page> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Em que local o câncer de pulmão geralmente começa?',
