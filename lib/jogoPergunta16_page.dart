...
class JogoPergunta16Page extends StatefulWidget {
  const JogoPergunta16Page({super.key});

  @override
  State<JogoPergunta16Page> createState() => _JogoPergunta16Page();
}

class _JogoPergunta16Page extends State<JogoPergunta16Page> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'O tratamento com radioterapia serve para:',
            ...
            Container(
              ...
              child: Column(
                children: [
                  opcao('A', 'Curar gripe'),
                  opcao('B', 'Remover pedras nos rins'),
                  opcao('C', 'Destruir células cancerígenas'),
                  opcao('D', 'Tratar alergias'),
                ],
              ),
            ),
