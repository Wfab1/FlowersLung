...
class JogoPergunta3Page extends StatefulWidget {
  const JogoPergunta3Page({super.key});

  @override
  State<JogoPergunta3Page> createState() => _JogoPergunta3Page();
}

class _JogoPergunta3Page extends State<JogoPergunta3Page> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Qual é um sintoma comum do câncer de pulmão?',
            ...
            Container(
              ...
              child: Column(
                children: [
                  opcao('A', 'Dor abdominal frequente'),
                  opcao('B', 'Tosse persistente'),
                  opcao('C', 'Coceira na pele'),
                  opcao('D', 'Visão embaçada'),
                ],
              ),
            ),
